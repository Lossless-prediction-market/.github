...
- **Sponsor Token (sp-):** Minted when a sponsor deposits liquidity to boost pool yield
...
Nulloss uses **Morpho Blue** as its primary yield source. Morpho Blue is a minimal, immutable lending protocol (650 lines of audited code) that creates isolated markets per asset pair.
...
This fee model was deliberately designed to address the sustainability failure of earlier lossless prediction market protocols, which launched without clear revenue paths and did not survive the 2022 bear market.
...
For institutional participants, Nulloss offers USYC-denominated prediction pools. In a USYC pool:
...
- **USDC pools:** Primary retail and institutional markets
- **EURC pools:** Euro-denominated markets for European participants
- **USYC pools:** Institutional yield-bearing markets
...
- Reference implementation research complete (based on Entropyfi protocol archaeology)
...
Nulloss Markets is informed by deep analysis of Entropyfi, the first lossless prediction market protocol, which launched on Polygon in November 2021, raised $1.6M, and shut down in 2022.

Entropyfi proved the lossless mechanic works. It did not survive long enough to see prediction markets go mainstream. The protocol had no sustainable revenue model, launched on infrastructure not purpose-built for stablecoin-native financial applications, and was caught by the 2022 bear market before reaching product-market fit.

Nulloss addresses each of these failure points directly:
- Revenue model built into the architecture from day one
- Built on Arc, infrastructure purpose-designed for stablecoin-native finance
- Launching in 2026, when prediction markets are a proven category with demonstrated institutional interest
- Morpho Blue instead of Aave, with better yield isolation and a lower attack surface
...
- **GitHub**: https://github.com/nulloss
- **Builder**: [@jadeofwallstreet](https://twitter.com/wallstreetjade)
- **Arc Explorer**: https://testnet.arcscan.app

---

*Nulloss Markets is under active development. Smart contracts have not been audited. Do not deploy capital on testnet builds.*
